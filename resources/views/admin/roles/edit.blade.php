                                            ...
                                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                                <form class="theme-form theme-form-2 mega-form"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label
                                                                class="col-lg-2 col-md-3 col-form-label form-label-title">Display
                                                                Name</label>
                                                            <div class="col-md-9 col-lg-10">
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="js-example-basic-single w-100" name="group"
                                                                    value="{{ $role->group }}">
                                                                    <option disabled>Chọn Group</option>
                                                        ...
                                                        <div class="container">
                                                            <label
                                                                class="form-label-title col-lg-2 col-md-3 mb-0">Permission</label>
                                                            <div class="row">
