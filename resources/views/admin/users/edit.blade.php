                                                    ...
                                                    <div class="row">
                                                        <div class="mb-4 row align-items-center">
                                                            ...
                                                            <div class="col-5" style="text-align: center;">
                                                                <img src="{{ $user->image }}" id="show-image"
                                                                    alt=""
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            ...
                                                            <div class="col-md-9 col-lg-10">
                                                                <textarea class="form-control" type="text" value="{{ old('address') ?? $user->address }}" name="address"> </textarea>
                                                            </div>
                                                            @error('address')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
